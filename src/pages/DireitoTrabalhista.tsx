      ...
      <main className="pt-32 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-8 prose prose-lg text-brand-secondary">
            <h2 className="font-serif text-3xl text-brand-primary mb-6">A importância do Direito Trabalhista</h2>
            <p className="mb-6">
            ...
            <h3 className="font-serif text-2xl text-brand-primary mb-4">Principais Situações</h3>
            ...
            <div className="bg-black/5 p-10 mt-12">
              <h4 className="font-serif text-2xl text-brand-primary mb-4">Como funciona o atendimento</h4>
              <p className="mb-0">
