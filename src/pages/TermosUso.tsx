    ...
    <>
      ...
      <main className="pt-40 pb-32">
        <div className="max-w-4xl mx-auto px-6 lg:px-20">
          ...
          <h1 className="font-poppins text-4xl md:text-5xl text-brand-primary mb-12">Termos de Uso</h1>
          ...
          <div className="prose prose-lg text-brand-secondary font-gilroy leading-relaxed">
            ...
            <h2 className="font-poppins text-2xl text-brand-primary mt-12 mb-4">1. Natureza Informativa</h2>
            ...
            <h2 className="font-poppins text-2xl text-brand-primary mt-12 mb-4">2. Propriedade Intelectual</h2>
            ...
            <h2 className="font-poppins text-2xl text-brand-primary mt-12 mb-4">3. Limitações de Responsabilidade</h2>
