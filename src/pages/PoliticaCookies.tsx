    ...
    <>
      ...
      <main className="pt-40 pb-32">
        <div className="max-w-4xl mx-auto px-6 lg:px-20">
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-brand-primary mb-12">Política de Cookies</h1>
          ...
          <div className="prose prose-lg text-brand-secondary font-sans leading-relaxed">
            ...
            <h2 className="font-serif text-2xl text-brand-primary mt-12 mb-4">1. O que são cookies?</h2>
            ...
            <h2 className="font-serif text-2xl text-brand-primary mt-12 mb-4">2. Cookies Essenciais</h2>
            ...
            <h2 className="font-serif text-2xl text-brand-primary mt-12 mb-4">3. Controle e Desativação</h2>
