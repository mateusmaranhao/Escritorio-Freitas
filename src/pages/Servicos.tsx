        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-brand-primary/10">
            ...
            <div className="bg-brand-surface p-12 lg:p-16 flex flex-col justify-between">
              <div>
                <h2 className="font-serif text-3xl text-brand-primary mb-4">Direito Trabalhista</h2>
                <p className="font-sans text-brand-secondary leading-relaxed mb-8">
                  Orientação jurídica para relações de trabalho, atuando de forma preventiva e contenciosa.
                </p>
                <div className="mb-12">
                  <strong className="block font-sans text-xs uppercase tracking-widest text-brand-primary mb-3">Principais Situações:</strong>
                  <ul className="flex flex-col gap-2 font-sans text-sm text-brand-secondary">
              ...
              <Link to="/servicos/direito-trabalhista" className="inline-flex items-center gap-4 font-sans text-[13px] uppercase tracking-widest text-brand-primary hover:gap-6 transition-all duration-300">
            ...
            <div className="bg-brand-surface p-12 lg:p-16 flex flex-col justify-between">
              <div>
                <h2 className="font-serif text-3xl text-brand-primary mb-4">Direito Previdenciário</h2>
                <p className="font-sans text-brand-secondary leading-relaxed mb-8">
              ...
              <Link to="/servicos/direito-previdenciario" className="inline-flex items-center gap-4 font-sans text-[13px] uppercase tracking-widest text-brand-primary hover:gap-6 transition-all duration-300">
            ...
            <div className="bg-brand-surface p-12 lg:p-16 flex flex-col justify-between">
              <div>
                <h2 className="font-serif text-3xl text-brand-primary mb-4">Direito Imobiliário</h2>
                <p className="font-sans text-brand-secondary leading-relaxed mb-8">
              ...
              <Link to="/servicos/direito-imobiliario" className="inline-flex items-center gap-4 font-sans text-[13px] uppercase tracking-widest text-brand-primary hover:gap-6 transition-all duration-300">
            ...
            <div className="bg-brand-surface p-12 lg:p-16 flex flex-col justify-between">
              <div>
                <h2 className="font-serif text-3xl text-brand-primary mb-4">Direito Empresarial</h2>
                <p className="font-sans text-brand-secondary leading-relaxed mb-8">
